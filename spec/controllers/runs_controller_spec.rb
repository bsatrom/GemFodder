  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested run" do
        ...
        Run.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => run.id, :run => {'these' => 'params'}
      end

      it "assigns the requested run as @run" do
        run = Run.create! valid_attributes
        put :update, :id => run.id, :run => valid_attributes
        assigns(:run).should eq(run)
      end
